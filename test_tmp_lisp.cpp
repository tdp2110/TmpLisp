...
int main() {
  ...
  static_assert(
      is_same_v<Eval_t<SExp<TestLambda1, False, Three>, TestEnv2>, Three>);
  ...
  static_assert(
      is_same_v<Eval_t<SExp<Op<OpCode::Mul>, Two, Three>, Env<>>, Int<2 * 3>>);

  static_assert(
      is_same_v<Eval_t<SExp<Op<OpCode::Eq>, Two, Three>, Env<>>, False>);

  using TestFunc2 =
      Eval_t<Lambda<SExp<Op<OpCode::Add>, Var0, Var1>, Env<Binding<Var0, One>>>,
  ...
  static_assert(is_same_v<Eval_t<SExp<Op<OpCode::Add>>, EmptyEnv>, Int<0>>);

  static_assert(is_same_v<Eval_t<SExp<Op<OpCode::Mul>>, EmptyEnv>, Int<1>>);

  static_assert(
      is_same_v<Eval_t<SExp<Op<OpCode::Eq>, Int<1>, EmptyList>, EmptyEnv>,
                Bool<false>>);

  static_assert(
      is_same_v<Eval_t<SExp<Op<OpCode::Neq>, Int<1>, EmptyList>, EmptyEnv>,
                Bool<true>>);
  ...
  static_assert(
      is_same_v<Eval_t<SExp<Op<OpCode::Add>, Int<1>, Int<2>, Int<3>>, EmptyEnv>,
                Int<6>>);

  static_assert(
      is_same_v<Eval_t<SExp<Op<OpCode::Mul>, Int<1>, Int<2>, Int<3>>, EmptyEnv>,
                Int<6>>);

  static_assert(
      is_same_v<
          Eval_t<SExp<Op<OpCode::And>, Bool<true>, Bool<true>, Bool<false>>,
                 EmptyEnv>,
          Bool<false>>);

  static_assert(is_same_v<Eval_t<SExp<Op<OpCode::Or>, Bool<true>, Bool<true>,
                                      Bool<false>, Bool<false>, Bool<false>>,
                                 EmptyEnv>,
                          Bool<true>>);

  static_assert(is_same_v<Eval_t<SExp<Op<OpCode::Eq>, Bool<true>, Bool<true>,
  ...
  static_assert(is_same_v<Eval_t<SExp<Fact2, Int<4>>, EmptyEnv>, Int<24>>);
  ...
  *******************/
  ...
  static_assert(is_same_v<Eval_t<SExp<IsOdd, Int<12>>, EmptyEnv>, Bool<false>>);
  static_assert(is_same_v<Eval_t<SExp<IsOdd, Int<41>>, EmptyEnv>, Bool<true>>);
  ...
  static_assert(is_same_v<Eval_t<SExp<Op<OpCode::Car>, TestList>, TestEnv>,
                          AnotherValue>);

  static_assert(
      is_same_v<Eval_t<SExp<Op<OpCode::Car>, SExp<Op<OpCode::Cdr>, TestList>>,
                       TestEnv>,
                SomeValue>);
